# nodejs-hw-mongodb-hw5-auth

Завдання

Вам потрібно продовжити створення додатку для роботи з колекцією контактів. Додайте колекцію користувачів та відповідні роути для роботи з нею: реєстрація, логін, логаут і рефреш. Доповніть логіку існуючих роутів контактів аутентифікацією.

Критерії прийому

Завдання виконано на гілці hw5-auth
При здачі домашньої роботи є посилання на вихідні файли на Github та посилання на задеплоєний проєкт цієї ДЗ (гілка hw5-auth) на render.com
